describe("Data Graph testing", () => {
  ...
  it("Contains correct UI during no data.", () => {
    ...
    cy.location("pathname").should("equal", "/projects/data-graph");
  ...
  it("Contains correct Data Graph behavior.", () => {
    ...
    cy.contains(/project time series data/i).should("not.be.exist");
    cy.get(".ant-select-item-option-content").eq(0).click();
    cy.contains(/project time series data/i).should("be.visible");
